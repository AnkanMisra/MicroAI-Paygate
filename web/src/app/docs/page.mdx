...
- The verifier recovered the signer and rejected replayed nonces using the configured memory or Redis store.
...
- Multi-replica replay protection requires `VERIFIER_NONCE_STORE=redis`; the memory mode remains single-process.
