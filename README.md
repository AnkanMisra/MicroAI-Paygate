...
- `MAX_REQUEST_BODY_BYTES`: verifier request body limit in bytes. Default `1048576` (1MB).
...
| `MAX_REQUEST_BODY_BYTES` | Verifier | Maximum request body size in bytes for verifier. Default `1048576` (1MB). |
