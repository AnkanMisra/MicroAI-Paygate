...
- Redis: shared verifier nonce claims, receipt storage, and optional response cache.
...
The verifier owns EIP-712 parity, signer recovery, chain ID enforcement, timestamp freshness, and nonce replay protection through either process-local memory or shared Redis.
